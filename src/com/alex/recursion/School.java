...
//    private static Word a = v -> v.get(0).equals("E") && v.get(0).equals("D") ? 1 : 0;
    private static Word a = v -> 0;
    private static Word b = v -> v.get(1).equals("B") ? 1 : 0;
    private static Word e = v -> v.get(0).equals("D") && v.get(1).equals("E") && !v.get(4).equals("A") ? 1 : 0;
    private static Word d = v -> !v.get(0).equals("C") && ((e.say(v) == 1) || v.get(1).equals("D")) ? 1 : 0;
    private static Word c = v -> v.get(4).equals("A") && ((v.get(0).equals("C") && d.say(v) == 0)|| v.get(1).equals("C")) && !v.get(0).equals("E")? 1 : 0;
